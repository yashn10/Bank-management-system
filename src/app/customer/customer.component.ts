...
export class CustomerComponent implements OnInit {
  ...
  update1() {
    ...
    this.customerlist[this.indexselected1].firstname1 = this.customerForm.value.firstname1;
    this.customerlist[this.indexselected1].lastname1 = this.customerForm.value.lastname1;
    this.customerlist[this.indexselected1].email1 = this.customerForm.value.email1;
    // this.customerlist[this.indexselected1].contact1 = this.customerForm.value.contact1;
    localStorage.setItem('customer', JSON.stringify(this.customerlist));
